...
#ifndef INTENSITY_MEASUREMENT_TESTS_H_
#define INTENSITY_MEASUREMENT_H_
...
class IntensityMeasurementTests : public CPPUNIT_NS :: TestFixture
{
public:
	CPPUNIT_TEST_SUITE (IntensityMeasurementTests);

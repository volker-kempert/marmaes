...
#ifndef COMPOSITE_MEASUREMENT_TESTS_H_
#define COMPOSITE_MEASUREMENT_TESTS_H_
...
class CompositeMeasurementTests : public CPPUNIT_NS :: TestFixture
{
public:
	CPPUNIT_TEST_SUITE (CompositeMeasurementTests);
	...
	CPPUNIT_TEST (test_09_availableMeasures);
	...
	protected:
		...
		void test_09_availableMeasures (void);
	private:
		CompositeMeasurement* cm_;
